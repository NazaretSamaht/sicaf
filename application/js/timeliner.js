...
;(function($) {
        ...
        function startTimeliner(options){
            var settings = {
                ...
                // event marker
                speed: options['speed'] || 2, // value: numeric, defalut to 4; a
                ...
                expandAllText: options ['expandAllText'] || '+ Expandir Todos', // value:
                // string, sets the text of the expandAll selector
                // after the timeline is fully collapsed
                collapseAllText: options['collapseAllText'] || '- Retraer Todos' // // value:
                // string, sets the text of the expandAll selector
